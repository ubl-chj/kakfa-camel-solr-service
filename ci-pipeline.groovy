    ...
    stages {
        ...
        stage('Dependency Check') {
            ...
            steps {
                ...
                dependencyCheckAnalyzer datadir: 'dependency-check-data', includeVulnReports: true, isFailOnErrorDisabled: true, hintsFile: '', includeCsvReports: false, includeHtmlReports: true, includeJsonReports: false, isAutoupdateDisabled: true, outdir: '', scanpath: '', skipOnScmChange: false, skipOnUpstreamChange: false, suppressionFile: '', zipExtensions: ''
